# Data Entry Job Automation _Zillow Rental Research
...
# set following to valid Google Sheets Spreadsheet url
...
def enter_details(entry):
    ...
    time.sleep(2)
    # fix partial urls, using a ternary operator
...
rentals = []
# get listings from multiple pages, limiting the number
